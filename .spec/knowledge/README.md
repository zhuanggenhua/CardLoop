...
| 文档 | 一句话 |
|------|--------|
| [`standards/gameplay-architecture.md`](standards/gameplay-architecture.md) | Gameplay 地基架构规范:吸收 StackCraft/2DRPGEngine/UE/Unity 参考、裁决对象模型/系统边界/Mod/联机扩展时查 |
| [`standards/workflow.md`](standards/workflow.md) | 开发与规范治理流程:处理任务前提、执行边界、提交限制、知识沉淀和 LumioAgent 结构吸收时查 |
...
| [`standards/skill-conflicts.md`](standards/skill-conflicts.md) | LumioAgent skill 整合矩阵:查看 FantasyWord 迁入 skill 如何在 CardLoop 收口、合并或排除时查 |
...
| [`features/project/README.md`](features/project/README.md) | CardLoop 项目事实入口:涉及产品愿景、Gameplay 地基、StackCraft 吸收、Mod、联机或项目阶段事实时查 |
