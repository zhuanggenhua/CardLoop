---
name: unity-script
description: 'Unity C# 脚本入口。用于创建、读取、替换、追加、搜索、重命名、移动、删除脚本和编译反馈。'
---

# Unity Script Skills

> **BATCH-FIRST**: Use `script_create_batch` when creating 2+ scripts.
> **DESIGN-FIRST**: Before creating gameplay scripts, actively consider coupling, performance, and maintainability. In an existing project, load `../project-scout/MODULE.md` first. If the user is asking for architecture or refactoring advice, load `../architecture/MODULE.md` and then `../patterns/MODULE.md`, `../async/MODULE.md`, `../inspector/MODULE.md`, `../performance/MODULE.md`, `../script-roles/MODULE.md`, `../scene-contracts/MODULE.md`, `../testability/MODULE.md`, or `../scriptdesign/MODULE.md` as needed.
