...
description: 'Unity Shader Graph 操作入口。用于创建 graph、检查结构、编辑 blackboard 和受控节点修改。'
---
...
- Source-anchored design guidance before proposing graph architecture: load [shadergraph-design](../shadergraph-design/MODULE.md)
