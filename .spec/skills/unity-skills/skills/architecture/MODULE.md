...
description: 'Unity 架构入口。用于模块边界、解耦、场景组合、SOLID、职责拆分和结构性重构。'
---
...
- Pattern choice: see [`../patterns/MODULE.md`](../patterns/MODULE.md)
- Async / Update / UniTask decisions: see [`../async/MODULE.md`](../async/MODULE.md)
- Inspector-facing field design: see [`../inspector/MODULE.md`](../inspector/MODULE.md)
- Script quality review: see [`../scriptdesign/MODULE.md`](../scriptdesign/MODULE.md)
