...
Sub-doc of [unitask-design](./MODULE.md). Every item below is a real pattern that breaks in production. Read this before reviewing a PR that touches async code.
