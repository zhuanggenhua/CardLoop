...
Sub-doc of [unitask-design](./MODULE.md). Covers every bridge between UniTask and Unity's legacy `AsyncOperation` / `Coroutine`, and between UniTask and `System.Threading.Tasks.Task`.
