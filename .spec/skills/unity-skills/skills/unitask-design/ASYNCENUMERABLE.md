...
Sub-doc of [unitask-design](./MODULE.md). Covers UniTask's answer to IObservable / IAsyncEnumerable — the `IUniTaskAsyncEnumerable<T>` interface and the `UniTaskAsyncEnumerable` static factory.
