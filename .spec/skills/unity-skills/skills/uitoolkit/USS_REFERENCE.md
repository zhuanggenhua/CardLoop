...
description: "Extended UI Toolkit USS reference — design tokens, reusable layout/component patterns, and an end-to-end USS example beyond the uitoolkit MODULE.md. UI Toolkit USS 扩展参考(设计令牌、可复用布局/组件模式、超出 uitoolkit MODULE.md 的端到端 USS 示例)。"
type: reference
---

# UI Toolkit USS Reference

Load this file when you need deeper USS design material, reusable layout/component patterns, or a full end-to-end example. The main `MODULE.md` keeps only routing rules and guardrails.
