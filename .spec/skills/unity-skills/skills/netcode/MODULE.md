---
name: unity-netcode
description: 'Unity NGO 入口。用于 NetworkManager、NetworkObject/prefab、spawn、host/server/client 生命周期和多人联机脚手架。'
---
...
> **Strongly recommended**: before calling any `netcode_*` skill, load [netcode-design](../netcode-design/MODULE.md). NGO lifecycle and permission rules are strict; skills alone cannot prevent incorrect business code.
...
- Code-level design decisions (RPC direction, NetworkVariable permission) → [netcode-design](../netcode-design/MODULE.md) advisory
