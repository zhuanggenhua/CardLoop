...
Sub-doc of [dotween-design](./MODULE.md). Covers how DOTween interoperates with UniTask, Coroutines, Addressables/YooAsset-loaded assets, and Netcode-driven deterministic replay.
