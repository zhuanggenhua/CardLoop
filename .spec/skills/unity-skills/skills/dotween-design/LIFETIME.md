...
Sub-doc of [dotween-design](./MODULE.md). This is where most DOTween bugs live: tweens running on destroyed targets, tween pool exhaustion, tweens surviving scene load.
