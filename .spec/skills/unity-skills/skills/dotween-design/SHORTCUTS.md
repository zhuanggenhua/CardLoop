...
Sub-doc of [dotween-design](./MODULE.md). Shortcut extensions live across multiple files: `DOTween/ShortcutExtensions.cs` (core) plus Modules (`DOTweenModuleUI.cs`, `DOTweenModulePhysics.cs`, etc.).
