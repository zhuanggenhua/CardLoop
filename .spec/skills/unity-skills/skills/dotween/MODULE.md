---
name: unity-dotween
description: 'Unity DOTween 操作入口。用于检测安装、模块、设置、shortcuts、DOTweenAnimation 添加/批量/错峰/调参。'
---
...
- For source-level runtime API design rules, load [dotween-design](../dotween-design/MODULE.md).
