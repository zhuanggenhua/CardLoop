---
name: unity-shader-fileops
description: 'Unity .shader 文件操作入口。用于创建、读取、列出、查找、删除 ShaderLab/HLSL 文件，检查 properties/keywords/variants。'
---

# Unity Shader File Operations
