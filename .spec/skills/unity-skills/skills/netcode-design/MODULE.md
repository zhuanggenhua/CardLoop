...
description: 'NGO 设计规则入口。用于 authority、RPC、NetworkVariable、spawn、scene、transport、同步和联机调试。'
---
...
- Architecture-level decisions (Server-authoritative vs Distributed Authority) → also load [architecture](../architecture/MODULE.md)
