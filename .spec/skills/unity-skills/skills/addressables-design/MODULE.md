...
description: 'Unity Addressables 设计入口。用于初始化、handles、加载、catalog、下载、AssetReference、热更和版本迁移。'
---
...
- Asmdef layout for Addressables consumers → load [asmdef](../asmdef/MODULE.md)
- Async orchestration across multiple Addressables operations → load [async](../async/MODULE.md)
- Architecture-level decisions (Addressables vs YooAsset, group strategy) → load [architecture](../architecture/MODULE.md)
