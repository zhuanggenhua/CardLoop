...
Source for every "why it's wrong" claim: the files listed in the main [MODULE.md](./MODULE.md) rule table plus `CHANGELOG.md`. When in doubt, grep the Runtime or Editor directory before emitting code.
