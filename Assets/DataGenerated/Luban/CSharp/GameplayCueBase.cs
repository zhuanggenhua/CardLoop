...
public abstract partial class GameplayCueBase : Luban.BeanBase
{
    ...
    public static GameplayCueBase DeserializeGameplayCueBase(JSONNode _buf)
    {
        switch ((string)_buf["$type"])
        {
            ...
            case "CuePlayGameCoreAnimator": return new CuePlayGameCoreAnimator(_buf);
            case "CuePlayGameCoreAudio": return new CuePlayGameCoreAudio(_buf);
            case "CuePlayGameCoreFeedback": return new CuePlayGameCoreFeedback(_buf);
