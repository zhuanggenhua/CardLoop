...
public sealed partial class gameplayEffect : Luban.BeanBase
{
    public gameplayEffect(JSONNode _buf) 
    {
        ...
        { var _j = _buf["FormalDamage"]; if (_j.Tag != JSONNodeType.None && _j.Tag != JSONNodeType.NullValue) { { if(!_j.IsObject) { throw new SerializationException(); }  FormalDamage = global::cfg.FormalDamage.DeserializeFormalDamage(_j);  } } else { FormalDamage = null; } }
        { var _j = _buf["FormalConditionalDamage"]; if (_j.Tag != JSONNodeType.None && _j.Tag != JSONNodeType.NullValue) { { if(!_j.IsObject) { throw new SerializationException(); }  FormalConditionalDamage = global::cfg.FormalConditionalDamage.DeserializeFormalConditionalDamage(_j);  } } else { FormalConditionalDamage = null; } }
    }
    ...
    public override string ToString()
    {
        ...
        + "Stacking:" + Stacking + ","
        + "FormalDamage:" + FormalDamage + ","
        + "FormalConditionalDamage:" + FormalConditionalDamage + ","
        + "}";
    }
}
}
