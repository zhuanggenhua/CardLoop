...
namespace GamePlay
{
    ...
    /// </summary>
    [Serializable]
    public sealed class GamePlayActionSlotDefinition
    {
        [Header("槽位身份")]
        ...
        private GamePlayContentId[] m_allowedContentIds = Array.Empty<GamePlayContentId>();
        ...
        public IReadOnlyList<GamePlayContentId> AllowedContentIds =>
            m_allowedContentIds ?? Array.Empty<GamePlayContentId>();
    ...
    /// </summary>
    public static class GamePlayActionParticipationEvaluator
    {
        /// <summary>
        /// 检查已明确分配给槽位的参与对象数量。无效槽位、负数和作者配置矛盾都返回 false。
        /// </summary>
        public static bool IsParticipantCountSatisfied(GamePlayActionSlotDefinition slot, int participantCount)
        {
