...
namespace Gameplay.Actions
{
    ...
    public class ActionDefinition : ContentAsset
    {
        [Header("回合消耗")]
        ...
        public IReadOnlyList<ActionSlotDefinition> ParticipationSlots =>
            m_participationSlots ?? Array.Empty<ActionSlotDefinition>();
        ...
        public IReadOnlyList<ActionResultBranchDefinition> ResultBranches =>
            m_resultBranches ?? Array.Empty<ActionResultBranchDefinition>();
