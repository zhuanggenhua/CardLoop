...
namespace GamePlay
{
    ...
    /// </summary>
    [Serializable]
    public abstract class GamePlayActionResultIntent
    {
    }
    ...
    /// </summary>
    [Serializable]
    public sealed class GamePlayActionResultBranch
    {
    ...
    /// </summary>
    [Serializable]
    public sealed class TabletopCardRemoveResultIntent : GamePlayActionResultIntent
    {
    ...
    /// </summary>
    [Serializable]
    public sealed class TabletopCardCreateResultIntent : GamePlayActionResultIntent
    {
        [SerializeField, InspectorName("产物内容 ID"), Tooltip("生成卡牌引用的唯一 GamePlay 内容身份；必须已进入当前内容索引。")]
        private GamePlayContentId m_contentId;
        ...
        public GamePlayContentId ContentId => m_contentId;
