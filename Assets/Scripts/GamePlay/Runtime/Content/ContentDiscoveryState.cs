...
namespace Gameplay.Content
{
    ...
    /// </summary>
    public sealed class ContentDiscoveryState
    {
        private readonly HashSet<ContentId> m_discoveredContentIds = new();
        ...
        /// </summary>
        public bool IsDiscovered(ContentId contentId)
        {
        ...
        /// </summary>
        public bool MarkDiscovered(ContentId contentId, ContentIndex contentIndex)
        {
