...
namespace GAS.Runtime
{
    ...
    {
        public const string GAME_CONF_DIR = "Assets/DataGenerated/Luban/Json/GAS";
        ...
        public static GameplayEffectConfig GetGameplayEffectConfig(int id)
        {
            ...
            (int[] all, int[] any, int[] none)? ParseTagRequirement(cfg.TagRequirementData requirement)
            {
                ...
                if(all != null && all.Length == 0) all = null;
                if(any != null && any.Length == 0) any = null;
                if(none != null && none.Length == 0) none = null;
            ...
            else
            {
                ...
                if (abilityParam != null)
                {
                    switch (abilityLogic)
                    {
                        ...
                        case cfg.FormalAbilityRuleProxyLogic aData:
                        {
                            var ap = abilityParam as GAS.Runtime.XParamNone;
                            abilityParam = ap;
                            break;
                        }
                    }
