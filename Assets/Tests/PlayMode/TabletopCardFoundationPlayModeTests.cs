...
namespace GamePlay.Tests
{
    ...
    /// </summary>
    public sealed class TabletopCardFoundationPlayModeTests : InputTestFixture
    {
        [UnityTest]
        ...
        {
            Mouse mouse = InputSystemApi.AddDevice<Mouse>("GamePlayFoundationMouse");
            Keyboard keyboard = InputSystemApi.AddDevice<Keyboard>("GamePlayFoundationKeyboard");
            ...
            Assert.That(
                controller.DiscoveryState.IsDiscovered(
                    new GamePlayContentId(TabletopCardFoundationTestController.TestActionContentId)),
                Is.True,
            ...
            GamePlayWorldTurnSystem worldTurnSystem = GameManager.GetSystem<GamePlayWorldTurnSystem>();
            ...
            Assert.That(
                controller.CardState.Stacks.Any(stack =>
                    stack.Cards.Any(card =>
                        card.ContentId.Value == TabletopCardFoundationTestController.TestProductContentId)),
                Is.False);
        ...
        private static IEnumerator LoadFoundationTabletop()
        {
            ...
            TabletopCardFoundationTestController controller = null;
            while (controller == null || !controller.IsReady ||
                   !AreAllViewsReady())
            {
                Assert.Less(Time.realtimeSinceStartup, timeoutAt, "牌桌测试视图实例化超时。");
                controller = Object.FindAnyObjectByType<TabletopCardFoundationTestController>();
                yield return null;
            }
        }
