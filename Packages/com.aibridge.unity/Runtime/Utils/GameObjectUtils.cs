...
namespace UnityAiBridge.Utils
{
    public static partial class GameObjectUtils
    {
        ...
        public static string? Print(this GameObject? go) => go == null
            ? null
            : $"instanceID: {ObjectIdCompat.GetInstanceId(go)}, path: {go.GetPath()}, bounds: {System.Text.Json.JsonSerializer.Serialize(go.CalculateBounds(), BridgeReflector.DefaultJsonOptions)}";
